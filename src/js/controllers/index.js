...
(function () {
  ...
  angular.module('copayApp.controllers')
    .controller('indexController',
      function ($rootScope, $scope, $log, $filter, $timeout, lodash, go, profileService, configService, isCordova, storageService, addressService, gettext, gettextCatalog, amMoment, nodeWebkit, addonManager, txFormatService, uxLanguage, $state, isMobile, addressbookService, notification, animationService, fundingNodeService, $modal, bwcService, backButton) { // eslint-disable-line max-len
        ...
        self.setBalance = function (assocBalances, assocSharedBalances) {
          ...
          console.group('BALANCE');
          console.log(self.arrBalances);
          console.log(self.dagBalance);
          console.groupEnd('BALANCE');
...
//  });
        ...
        lodash.each(['NewTxProposal', 'TxProposalFinallyRejected', 'TxProposalRemoved', 'NewOutgoingTxByThirdParty', 'Local/NewTxProposal', 'Local/TxProposalAction'], (eventName) => {
